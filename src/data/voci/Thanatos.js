export default {
  ...
  contenuto: [
    ...
    {
      tipo: "paragrafo",
      testo: "La sua figura si distingue nettamente da quella delle Keres (Κῆρες), le spaventose divinità femminili della morte violenta e loto-fagiche che infuriavano sui campi di battaglia, bramose di sangue, brandendo artigli e strappando le anime dai corpi dei soldati caduti tra urla e strazio. Thanatos, al contrario, non porta segni di violenza: il suo intervento è silenzioso, ordinato e rispettoso del ciclo cosmico stabilito dalle Moire."
    },
    {
      tipo: "sottotitolo",
    ...
    {
      tipo: "paragrafo",
      testo: "Il legame simmetrico con il fratello gemello Hypnos (il Sonno) trova riscontro in in poesia e filosofia. I Greci chiamavano il sonno 'il fratello minore della morte'. Nell'iconografia vascolare attica, i due fratelli venivano spesso rappresentati come efebi alati che depongono con delicatezza i corpi dei defunti. Tuttavia, mentre Hypnos visita l'uomo periodicamente per donargli sollievo e svanisce al risveglio, Thanatos compie il viaggio di sola andata verso le braccia di Ade e Persefone."
    },
    {
      tipo: "sottotitolo",
